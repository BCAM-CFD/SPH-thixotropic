...
!!$           mi,mj,w,gradw,fi,fj,auij,stat_info)
        ...
        REAL(MK), INTENT(IN)         :: ai
        REAL(MK), INTENT(IN)         :: bi
        REAL(MK), INTENT(IN)         :: aj
        REAL(MK), INTENT(IN)         :: bj
        !-----------------------------------
...
!!$        REAL(MK)                        :: f_c,f_d1,f_d2
        ...
        dt  = this%dt
        !--- Changed by Adolfo for Emanuele --
        ...
        IF ( this%Brownian .AND. &
           ...
           DO i =1,num_dim
              DO j = i+1,num_dim
                 ...
                 dW(j,i) = dW(i,j)
              END DO
              !--- Commented by Adolfo: warning, trace is really trace/dim
              dW(i,i) = dW(i,i) - trace
           END DO
           ...
           !********* Changed by Adolfo ************
!!$	   !******** Changed by Adolfo *******
           ! This has been already calculated above
!!$!           a   = 5.0_MK *eta/3.0_MK
