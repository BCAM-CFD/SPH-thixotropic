...
!------ Subroutine added by Adolfo for Emanuele ------------------
      SUBROUTINE particles_get_a(this,a,num,stat_info)
...
9999    CONTINUE
      ...
      END SUBROUTINE particles_get_a
!----------------------------------------------------

!------ Subroutine added by Adolfo for Emanuele ------------------
      SUBROUTINE particles_get_b(this,b,num,stat_info)
...
9999    CONTINUE
      ...
      END SUBROUTINE particles_get_b
!----------------------------------------------------
