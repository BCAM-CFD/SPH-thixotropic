      SUBROUTINE colloid_compute_interaction_implicit_velocity_pair_sweep_OLD(&
...
!        F0_repul = this%cc_repul_F0
	!*****************************
        ...
        !-- Added by Adolfo --
        eta_total = 155.5555555555555_MK
...
9999    CONTINUE
      ...
      END SUBROUTINE colloid_compute_interaction_implicit_velocity_pair_sweep_OLD
