      LOGICAL FUNCTION physics_check_parameters(this,stat_info)
        ...
        !------ Added by Adolfo --------------
        ! There is a problem in this function: the variable
        !  mcf_machine_zero is used, but it is non-initialized.
        !  It is initilized later, in the subroutine 
        ! technique_init_ppm. To avoid problems with this error,
        ! I will initialize this variable in here. In technique_init_ppm
        ! the variable will be redefined again.
        mcf_machine_zero = 1.0E-6
        !------------------------------------------
