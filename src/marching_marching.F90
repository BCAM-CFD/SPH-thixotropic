...
!           END IF
           ...
           CALL marching_integrate(this,step_current,time_current,dt,kt,&
                stat_info_sub)
...
9999    CONTINUE
      ...
      !--- Function added by Adolfo. It is an adaptation of the function random_random_Gaussian2 ---
      REAL(MK) FUNCTION random_random_colloid(stat_info) 
        !----------------------------------------------------
        ! Subroutine  : random_random_colloid
        !----------------------------------------------------
        !
...
!        stat_info = this%random_Gaussian_type        
        ...
        random_random_colloid = v/u
        
        RETURN
        
      END FUNCTION random_random_colloid
